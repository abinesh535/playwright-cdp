...
export class intakepageedit{
    ...
    constructor(page:Page){
        ...
        // this.intakedate=page.locator(`//*[normalize-space()='Intake Date']//div[@class='text-[13px] flex relative w-[120px] h-[38px] align-center']`);
        // this.socdate=page.locator(`//*[normalize-space()='SOC Date']//div[@class='text-[13px] flex relative w-[120px] h-[38px] align-center']`);
         ...
         //this.notrequiredcheck=page.locator(`button[value^='checklist_item_not_required']`)
         ...
         this.authedit=page.locator(`//*[@class="lucide lucide-ellipsis-vertical w-5 h-5"]`);
 ...
 for (let i = 1; i < count; i++) {
    ...
    async authfill():Promise<createauth>{
        await this.authdetail.click();
        await this.authedit.click()
        await this.clickcreatemanualauth.click();
        const authpopup = this.page.waitForEvent('popup')
        const popup = await authpopup;
        return new createauth(popup);
    }
}